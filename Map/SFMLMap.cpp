...
{
	return IntRect(positionToPixPosition(posCase,start).x+10,positionToPixPosition(posCase,start).y+10,positionToPixPosition(posCase+1,start).x-10,positionToPixPosition(posCase+1,start).y-10);
}
